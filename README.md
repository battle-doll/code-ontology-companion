...
> **See Code Ontology Companion analyze itself.** The
> [interactive self-ontology graph](docs/showcase/code-ontology-companion-self-ontology.html)
> was generated by Code Ontology Companion from its own v0.5.2 source: 955
> nodes and 2,378 evidence-backed relationships, without executing the target
> code. Download the self-contained HTML and open it in a browser to explore
> the accessible 2D view and optional 3D constellation.
