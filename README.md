...
Version 0.5.0 fully reanalyzes changed repositories. Private fingerprints avoid
...
and raw responses are not retained. Version 0.5.0 partitions that metadata in
...
Version 0.5.0 keeps every legacy direct relationship triple and stable identity,
