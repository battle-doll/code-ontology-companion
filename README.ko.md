...
> **Code Ontology Companion이 자기 자신을 분석했습니다.**
> [인터랙티브 자기 온톨로지 그래프](docs/showcase/code-ontology-companion-self-ontology.html)는
> Code Ontology Companion이 v0.5.2 자체 소스에서 생성한 결과입니다. 대상
> 코드를 실행하지 않고 955개 노드와 근거가 기록된 2,378개 관계를 구성했습니다.
> 자체 완결형 HTML을 내려받아 브라우저에서 접근 가능한 2D 보기와 선택형 3D
> 별자리 보기를 탐색할 수 있습니다.
