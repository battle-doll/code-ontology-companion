...
This document describes the implemented version 0.5.2 product. Code Ontology Companion turns
...
Version 0.5.2 retains the legacy `source`, `target`, and `type` relationship
...
triples can continue to read version 0.5.2 exports.
...
Version 0.5.2 defines executable ontology and visualization quality gates. The
...
This roadmap is directional, not a promise of dates. Version 0.5.2 advances the
...
into observed evidence are not version 0.5.2 capabilities. Version 0.5.2 does
