...
The source is licensed under Apache-2.0. These terms govern use of the plugin service/workflow and do not reduce rights granted by that software license.

This independent project is not affiliated with or endorsed by OpenAI, Broadcom, VMware, the Spring project, Oracle, or the Python Software Foundation.
